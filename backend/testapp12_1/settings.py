"""
Django settings for testapp12_1 project.
...
WSGI_APPLICATION = 'testapp12_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testapp12_1 API",
    "DESCRIPTION": "API documentation for testapp12_1 App",
    "VERSION": "v1",
}
